...
class Listar_Inspeccion_EstacionesSearch extends SearchDelegate<String> {
  final String idsstacionseleccionado = '';
  Future<Stations> getStations(String param) async {
    var url = '';
    if (isLocal) {
      url = '$UrlApiLocal/project/get_inspecciones_estacionesByParam/$param';
    } else {
      url = '$UrlApi/project/get_inspecciones_estacionesByParam/$param';
    }
